  ...
  facilityList: Facility[] = [
    {
      id:1,
      name:"House Vip",
      img:"https://tuvannhadep.com.vn/uploads/files/hinh-anh-nha-dep-8.jpg",
      area: 10,
      cost: 23,
      maxPeople:10,
      rentType:{
    ...
    {
      id:2,
      name:"Room Hơi bị vip",
      img:"https://thietbivesinhviglacera.net/uploads/tin-tuc/mau-nha-ve-sinh-dep-1.jpg",
      area: 5,
      cost: 23,
      maxPeople:10,
      rentType:{
    ...
    },
    {
      id:1,
      name:"VillaOfTan",
      img:"https://cdn.cet.edu.vn/wp-content/uploads/2019/02/villa-khong-gian-sang-trong.jpg",
      area: 20,
      cost: 23,
      maxPeople:10,
      rentType:{
    ...
    },
    {
      id:1,
      name:"VillaOfDuong",
      img:"https://homestay.review/wp-content/uploads/2021/04/villa-vungtau-5.jpg",
      area: 15,
      cost: 23,
      maxPeople:10,
      rentType:{
    ...
    },
    {
      id:1,
      name:"Villa sịn",
      img:"https://cdn1.ivivu.com/iVivu/2021/06/01/12/2-3-800x450.jpg",
      area: 10,
      cost: 23,
      maxPeople:10,
      rentType:{
    ...
    {
      id:1,
      name:"Room đẹp đáo để",
      img:"https://baocantho.com.vn/imagetsdt/tsdt/2022/20221006/images/H%201.jpg",
      area: 10,
      cost: 23,
      maxPeople:10,
      rentType:{
    ...
    },
    {
      id:1,
      name:"Phòng tù đẹp",
      img:"https://vcdn1-vnexpress.vnecdn.net/2018/02/01/nhagiam-5-1517496761.jpg?w=1200&h=0&q=100&dpr=1&fit=crop&s=iVuiVkgqafl3jFNesPBwwg",
      area: 10,
      cost: 23,
      maxPeople:10,
      rentType:{
